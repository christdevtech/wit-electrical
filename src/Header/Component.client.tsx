        ...
        <Link href="/">
          {hasLightModeLogo ? (
            <Media
              ...
              priority={true}
              alt="Light Mode Logo"
              className="max-w-[9.375rem] w-full h-[34px] dark:hidden"
            />
          ) : (
            <Logo
              loading="eager"
          ...
          {hasDarkModeLogo ? (
            <Media
              ...
              priority={true}
              alt="Dark Mode Logo"
              className="max-w-[9.375rem] w-full h-[34px] hidden dark:block"
            />
          ) : (
            <Logo
              loading="eager"
              priority="high"
              className="max-w-[9.375rem] w-full h-[34px] hidden dark:block invert"
            />
          )}
        </Link>
